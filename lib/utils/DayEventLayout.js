...
var Event = function () {
  ...
  _createClass(Event, [{
    ...
    get: function get() {
      ...
      if (this.container && this.container.data && this.container.data.$rendering === 'background') {
        availableWidth = 100;
      }
    ...
    get: function get() {
      // @BACKGROUND-EVENTS-HACK
      if (this.container && this.container.data && this.container.data.$rendering === 'background' && this.container.rows.includes(this)) {
        return 0;
      }
...
function getStyledEvents(_ref2) {
  ...
  var _loop = function _loop(i) {
    ...
    if (row) {
      ...
      event.leaves = [];
      if (container.startMs <= event.startMs && container.endMs > event.startMs) {
