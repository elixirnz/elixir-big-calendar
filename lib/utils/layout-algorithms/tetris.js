    ...
    for (var curLevel = 0; curLevel < numLevels - 1; ++curLevel) {
      var _loop = function _loop() {
        ...
        ;(_lowerEvent$children = lowerEvent.children).push.apply(
          ...
          (0, _toConsumableArray2.default)(childEvents)
        )
        ...
        for (_iterator5.s(); !(_step5 = _iterator5.n()).done; ) {
          ...
          if (ev.stretchable) {
            ...
            if (curLevel == 0) {
              ...
              var maxXOffset = 0
              var _iterator6 = (0, _createForOfIteratorHelper2.default)(
                  ev.parents
                ),
                _step6
              try {
            ...
            var _iterator7 = (0, _createForOfIteratorHelper2.default)(
                ev.children
              ),
              _step7
            try {
            ...
            if (curLevel == 0) {
              ...
              var _maxXOffset = 0
              var _iterator8 = (0, _createForOfIteratorHelper2.default)(
                  ev.parents
                ),
                _step8
              try {
...
function getStyledEvents(_ref3) {
  ...
  eventsInRenderOrder = [].concat(
    (0, _toConsumableArray2.default)(bgEvents),
    (0, _toConsumableArray2.default)(EV)
  )
