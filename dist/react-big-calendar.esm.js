...
PropTypes.oneOfType([PropTypes.oneOf(['overlap', 'no-overlap', 'tetris']), PropTypes.func]);
...
var _excluded$8 = ["style", "className", "event", "selected", "isAllDay", "onSelect", "onDoubleClick", "onKeyPress", "localizer", "continuesPrior", "continuesAfter", "accessors", "getters", "children", "components", "slotStart", "slotEnd"];
  ...
  var assemblyIntersectionGraph = function assemblyIntersectionGraph(eventsByLevel) {
    ...
    for (var curLevel = 0; curLevel < numLevels - 1; ++curLevel) {
      var _loop = function _loop() {
        ...
        (_lowerEvent$children = lowerEvent.children).push.apply(_lowerEvent$children, _toConsumableArray(childEvents));
      ...
      for (var j = 0; j < levelEvents.length; ++j) {
        if (levelEvents[j].localPeak) {
          ...
          if (allChildrenStretchable) {
            ...
            var _iterator3 = _createForOfIteratorHelper(levelEvents[j].children),
              _step3;
            try {
            ...
            var _iterator4 = _createForOfIteratorHelper(levelEvents[j].children),
              _step4;
            try {
...
function getStyledEvents$1(_ref3) {
  ...
  eventsInRenderOrder = [].concat(_toConsumableArray(bgEvents), _toConsumableArray(EV));
